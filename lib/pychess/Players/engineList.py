...
ENGINES_LIST = [
    ...
    ENGINE("chancellor", "", "unknown", 1590, NO_AUTO_DETECT, None),  # chancellor (no information)
    ENGINE("clownfish", "xboard", "it", 1566, NO_AUTO_DETECT, None),
    ENGINE("eubos", "uci", "gb", 1454, NO_AUTO_DETECT, None),
    ENGINE("thelightning", "", "de", 1442, NO_AUTO_DETECT, None),  # thelightning (no information)
